...
\begin{document}
	...
	\noindent \begin{tabular}{@{} l l}
		...
		\textbf{PROJECTS}    &1. \textbf{Eclassroom} - An IOT based project comprising of 4 modules. \\
			&2. \textbf{Rooms Plus Roommate Finder with Chat System} - Developed a\\ & WebApp which had 3 roles customer, partner and admin.\\
			&3. \textbf{Online Transportation Management Company} - Used Struts Framework\\ & for implementation.\\
			&4. \textbf{Digital Visiting Card With Barcode} -  Developed an Android App\\ & which can be an alternative to hardcopy visiting cards.\\
